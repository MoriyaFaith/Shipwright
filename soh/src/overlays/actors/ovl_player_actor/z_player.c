...
s32 Player_UseBowHookshot(Player* this, PlayState* play) {
    ...
    if ((this->heldItemAction >= PLAYER_IA_BOW_FIRE) && (this->heldItemAction <= PLAYER_IA_BOW_0E) &&
        ...
        Player_SetUpperActionFunc(this, Player_PrepareBowHookshot);
...
s32 Player_PrepareBowHookshot(Player* this, PlayState* play) {
    ...
    if ((this->unk_836 == 0) && (func_80833350(this) == 0) &&
        ...
        LinkAnimation_PlayOnce(play, &this->upperSkelAnime, D_808543CC[isHookshot]);
        this->unk_836 = -1;
    } else if (LinkAnimation_Update(play, &this->upperSkelAnime)) {
        LinkAnimation_PlayLoop(play, &this->upperSkelAnime, D_808543D4[isHookshot]);
        this->unk_836 = 1;
