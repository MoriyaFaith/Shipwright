...
void from_json(const json& j, SaveContext& saveContext) {
    ...
    j.contains("triforcePiecesCollected") ? j.at("triforcePiecesCollected").get_to(saveContext.triforcePiecesCollected) : saveContext.triforcePiecesCollected = 0;
}
...
std::string GameInteractorAnchor::clientVersion = "Anchor + Player Models 3 (alpha 2)";
